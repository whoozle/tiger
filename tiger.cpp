...
uint64_t tiger_hash::sandbox[4 * 256] = {
...
static void test(const char *data, size_t size) {
	printf("\"%.20s\": ", data);
	tiger_hash hash;
	do {
		size_t bsize = size > 1024? 1024: size;
		hash.update(data, bsize); //test block update
		data += bsize;
		size -= bsize;
	} while(size > 0);
	uint8_t r[24];
...
int main() {
	...
	test("a", 1);
	test("abc", 3);
	test("message digest", 14);
	test("12345678901234567890123456789012345678901234567890123456789012345678901234567890", 80);
	char * a = (char *)malloc(1000000);
	memset(a, 'a', 1000000);
	test(a, 1000000);
}
